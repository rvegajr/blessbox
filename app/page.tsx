                ...
                <div className="mb-6">
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-4 mb-4">
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white flex items-center justify-center shadow-md shrink-0"
                        aria-hidden="true"
                      >
                        <span className="text-lg font-black tracking-tight leading-none">FB</span>
                      </div>
                      <div className="min-w-0">
                        <p className="text-base font-semibold text-gray-900 truncate">Food Bank Central</p>
                        <p className="text-sm text-blue-600 truncate">blessbox.org/food-bank-central</p>
                        <p className="text-xs text-gray-500 truncate">admin@foodbankcentral.org</p>
                      </div>
                    </div>
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Register Your Organization</h3>
                    <p className="text-gray-600 mb-4">Get started with email-only sign-in, then set up your organization.</p>
