...
echo "***SQUARE_TOKEN_REDACTED***" | vercel env add SQUARE_ACCESS_TOKEN production --yes 2>/dev/null || echo "SQUARE_ACCESS_TOKEN already exists"
...
echo "***SQUARE_TOKEN_REDACTED***" | vercel env add SQUARE_ACCESS_TOKEN preview --yes 2>/dev/null || echo "SQUARE_ACCESS_TOKEN already exists"
