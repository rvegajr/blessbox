...
exports.ContextAwareTutorials = void 0;
/**
...
class ContextAwareTutorials {
    ...
    updateTriggerData(triggerId) {
        ...
        const data = this.getStorageData();
        data[triggerId] = {
            showCount: (((_a = data[triggerId]) === null || _a === void 0 ? void 0 : _a.showCount) || 0) + 1,
            lastShown: Date.now()
        };
...
exports.ContextAwareTutorials = ContextAwareTutorials;
